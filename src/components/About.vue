<template>
  <div
    class="container mx-auto h-full w-full xl:h-4/6 xl:w-5/12 bg-green-300 xl:rounded-3xl md:rounded-3xl"
  >
    <div class="about text-center">
      <h2 class="text-center text-lg font-bold my-5">About US</h2>

      <p
        class="text-md font-semibold text-justify mx-auto p-2 md:w-5/12 text-black"
      >
